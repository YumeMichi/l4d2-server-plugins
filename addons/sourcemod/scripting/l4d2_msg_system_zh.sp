...
public OnPluginStart()
{
    ...
    l4d2_msg_system_zh_tank_spawn = CreateConVar("l4d2_msg_system_zh_tank_spawn", "1", "开启tank产生提示", 0, false, 0.0, false, 0.0);
    l4d2_msg_system_zh_tank_killed = CreateConVar("l4d2_msg_system_zh_tank_killed", "1", "杀死tank提示", 0, false, 0.0, false, 0.0);
    l4d2_msg_system_zh_witch_killed = CreateConVar("l4d2_msg_system_zh_witch_killed", "1", "杀死witch提示", 0, false, 0.0, false, 0.0);
    l4d2_msg_system_zh_witch_harasser_set = CreateConVar("l4d2_msg_system_zh_witch_harasser_set", "1", "惊动witch提示", 0, false, 0.0, false, 0.0);
    l4d2_msg_system_zh_player_death = CreateConVar("l4d2_msg_system_zh_player_death", "1", "玩家死亡提示", 0, false, 0.0, false, 0.0);
    l4d2_msg_system_zh_create_panic_event = CreateConVar("l4d2_msg_system_zh_create_panic_event", "1", "触发警报提示", 0, false, 0.0, false, 0.0);
    ...
    l4d2_msg_system_zh_player_in_out = CreateConVar("l4d2_msg_system_zh_player_in_out", "1", "玩家进入退出提示", 0, false, 0.0, false, 0.0);
