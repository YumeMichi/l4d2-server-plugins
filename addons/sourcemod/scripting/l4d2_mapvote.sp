...
#define PLUGIN_VERSION	"0.666 beta"
...
public OnPluginStart()
{
	...
	RegAdminCmd("sm_votes", Command_MapVote, ADMFLAG_CHANGEMAP);
...
{
	new String:announce[] = "\x01[SM] To call a vote to change map/campaign votes, Type: \x04!votes\x01 in chat.";
